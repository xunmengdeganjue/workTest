...
__attribute__((section("__versions"))) = {
	...
	{ 0x6181bd1c, __VMLINUX_SYMBOL_STR(sock_release) },
	{ 0x44305dab, __VMLINUX_SYMBOL_STR(netlink_broadcast) },
	{ 0xf684706, __VMLINUX_SYMBOL_STR(skb_put) },
	...
	{ 0x2a803f6, __VMLINUX_SYMBOL_STR(skb_dequeue) },
...
MODULE_INFO(srcversion, "8C9A3D8BD74F87D50F0C658");
