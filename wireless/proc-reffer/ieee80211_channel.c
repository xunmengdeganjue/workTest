...
extern int lib_send_sig(int chann); //no need to send signal to aux module for channel change now
char
...
wlan_set_channel(wlan_if_t vaphandle, int chan, u_int8_t des_cfreq2)
{
    ...
    lib_send_sig(chan); // no need to send signal to aux module for channel change now
    return 0;
}
