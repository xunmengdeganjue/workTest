...
uci set wireless.spectrumWiFi.ssid='AAA-spectrumWifi-2G'
...
uci set wireless.spectrumWiFi.ownip=12.0.0.51
...
uci set wireless.spectrumWiFi5g.ssid=AAA-spectrumWifi-5G
...
uci set wireless.spectrumWiFi5g.ownip=12.0.0.51
...
uci set network.tap.ipaddr='11.0.0.253'
...
uci set network.com.ipaddr='12.0.0.51'
...
uci set network.tagv.ipaddr='11.0.0.253'
